...
//            i++;
//        }
//        UnreachableStateChecker(line, "/Users/fady/Desktop/report.txt");
    }
...
//        for (int f  = 0 ; states[f]!=null ; f++){
//            System.out.println(states[f]);
//            System.out.println(statesFlags[f]);
//        }
    }
            ...
            if (!found) {
                ...
                while (line[of] != null) {
                    if ((line[of].contains(regs[i]))) {
                        try {
                            int lineno = of + 1;
                            // System.out.print("arithmetic overflow at line " + (lineno));
                            //System.out.println(regs[i] + " is not initialized at line " + (lineno));
   ...
   /* System.out.println("****");
    for(int rr=0;rr<2;rr++){
        for(int kkk=0;kkk<100;kkk++){
            if(intialw[rr][kkk]==null)continue;
            try{
            System.out.println(intialw[rr][kkk]);
            }
            catch(Exception e){
            continue;
        }
    ...
    for(int rr=0;rr<2;rr++){
        //System.out.println("be5" +alwaysq[rr][3]+" be5 ");
        for(int kkk=0;kkk<100;kkk++){
            if(alwaysq[rr][kkk]==null)continue;
            try{
            System.out.println(alwaysq[rr][kkk]);
            }
            catch(Exception e){
            continue;
            }
